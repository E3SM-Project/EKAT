...
# perform as expected. This function is not aware of whether asserts
# are compiled away or not (i.e., whether the macro NDEBUG is present
# or not), so it is up to the user to call this function only in debug
# builds.
...
function(EkatCreateUnitTestWithAsserts test_base_name test_meta_src)
  ...
  # This trick forces a CMake to re-run if the source file changes.
  ...
  # Then, all the other tests (if any), which should *all* fail
  if (OUT EQUAL 0)
    return()
  endif()
