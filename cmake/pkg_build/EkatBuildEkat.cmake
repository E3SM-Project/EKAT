...
macro (setVars PREFIX SET_DEFAULTS)
  ...
  if (DEFINED ${PREFIX}_ENABLE_FPE_SUPPORT)
    set (EKAT_ENABLE_FPE_SUPPORT ${${PREFIX}_ENABLE_FPE_SUPPORT} CACHE BOOL "")
  elseif (SET_DEFAULTS)
    set (EKAT_ENABLE_FPE_SUPPORT ON CACHE BOOL "")
  endif()

  if (DEFINED ${PREFIX}_ENABLE_DEFAULT_FPE)
    set (EKAT_ENABLE_DEFAULT_FPE ${${PREFIX}_ENABLE_DEFAULT_FPE} CACHE BOOL "")
  elseif (SET_DEFAULTS)
    set (EKAT_ENABLE_DEFAULT_FPE OFF CACHE BOOL "")
  endif()
