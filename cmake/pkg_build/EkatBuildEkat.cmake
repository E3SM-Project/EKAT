...
macro (setVars PREFIX SET_DEFAULTS)
  ...
  elseif (SET_DEFAULTS)
    set (EKAT_ENABLE_FPE ON CACHE BOOL "")
  endif()

  if (DEFINED ${PREFIX}_ENABLE_FPE_DEFAULT_MASK)
    set (EKAT_ENABLE_FPE_DEFAULT_MASK ${${PREFIX}_ENABLE_FPE_DEFAULT_MASK} CACHE BOOL "")
  elseif (SET_DEFAULTS)
    set (EKAT_ENABLE_FPE_DEFAULT_MASK OFF CACHE BOOL "")
  endif()
