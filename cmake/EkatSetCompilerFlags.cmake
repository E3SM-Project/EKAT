  ...
  if (SRF_FLAGS)
    ...
    if (SRF_CXXFLAGS)
      ...
      elseif (CMAKE_CXX_COMPILER_ID STREQUAL "IntelLLVM")
        string (APPEND CMAKE_CXX_FLAGS_RELEASE " -sycl-std=2020 -qopenmp-simd -fsycl-device-code-split=per_kernel")
      endif()
    endif ()
  endif ()
endmacro()
...
macro (SetDebugFlags)
  ...
  if (SDF_FLAGS)
    ...
    if (SDF_CXXFLAGS)
      ...
      elseif (CMAKE_CXX_COMPILER_ID STREQUAL "IntelLLVM")
        string (APPEND CMAKE_CXX_FLAGS_DEBUG " -qopenmp-simd -Wsycl-strict -fno-sycl-dead-args-optimization")
      endif()
    endif ()
  endif ()
endmacro()
