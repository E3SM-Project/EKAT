...
macro (SetCompilerFlags ProjName)
  set (FP_MODEL_FLAG "")
  set (UT_FP_MODEL_FLAG "")
  if (DEFINED ${ProjName}_FPMODEL)
    EKAT_set_fpmodel_flags("${${ProjName}_FPMODEL}" FP_MODEL_FLAG)
    string(TOLOWER "${${ProjName}_FPMODEL}" fpmodel_string_lower)
    if (fpmodel_string_lower STREQUAL "strict")
      set (${ProjName}_STRICT_FP TRUE PARENT_SCOPE BOOL)
    endif()
