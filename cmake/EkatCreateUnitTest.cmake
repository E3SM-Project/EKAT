...
function(EkatCreateUnitTestFromExec test_name test_exec)
  ...
  if (ekat::CatchMain IN_LIST LINKED_LIBS)
    if (NOT ecutfe_EXE_ARGS)
      list(PREPEND ecutfe_EXE_ARGS "--use-colour no")
    elseif (NOT "--use-colour no" IN_LIST ecutfe_EXE_ARGS AND NOT "--use-colour yes" IN_LIST ecutfe_EXE_ARGS AND NOT )
      list(PREPEND ecutfe_EXE_ARGS "--use-colour no")
    endif()
  endif()
